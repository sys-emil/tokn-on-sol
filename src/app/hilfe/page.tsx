...
export const metadata: Metadata = {
  ...
  description: 'Antworten auf häufige Fragen zu Tickets, Anmeldung und Rückerstattungen — und der Draht zum Passly-Support.',
};
  ...
  return (
    <LegalPageShell title="Hilfe & Support" stand="7. Juli 2026">
      ...
      <p>
        ...
        derselben E-Mail-Adresse an, mit der du gekauft hast — das Ticket ist sofort wieder da.
