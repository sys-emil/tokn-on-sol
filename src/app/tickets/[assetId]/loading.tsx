      ...
      <div className="ticket-canvas">
        <div className="ticket-screen" aria-busy="true" aria-label="Ticket wird geladen">
          ...
          <div style={{ padding: '16px 22px 14px', display: 'grid', gap: 8 }}>
            <div className="sk" style={{ width: 96, height: 9 }} />
            <div className="sk" style={{ width: '78%', height: 17 }} />
            <div className="sk" style={{ width: 132, height: 11 }} />
          </div>

          <div className="ticket-body">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
              <div className="sk" style={{ width: 74, height: 20, borderRadius: 6 }} />
              <div className="sk" style={{ width: 46, height: 11 }} />
            </div>
            ...
            <div style={{ background: 'white', padding: 12, borderRadius: 12, boxShadow: '0 1px 2px rgba(17,20,45,0.06)', display: 'grid', placeItems: 'center' }}>
              <div style={{ width: 240 }}>
                <div className="sk block" style={{ width: 240, height: 240 }} />
              </div>
            </div>
            <div style={{ display: 'grid', placeItems: 'center', marginTop: 14 }}>
              <div className="sk" style={{ width: 186, height: 11 }} />
            </div>
          ...
          <div style={{ padding: '16px 22px 20px', display: 'grid', gap: 12 }}>
            {[68, 54, 76].map((w, i) => (
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', gap: 16 }}>
                ...
                <div className="sk" style={{ width: 108, height: 10 }} />
              </div>
            ))}
          </div>
        </div>
